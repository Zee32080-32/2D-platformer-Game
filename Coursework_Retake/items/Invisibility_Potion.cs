...
{
    class Invisibility_Potion
    {

        private Texture2D texture;
        private Vector2 origin;
        private SoundEffect InvisibilityPotion;
        ...
        public Invisibility_Potion(Level level, Vector2 position)
        {
            this.level = level;
            basePos = position;
        ...
        {
            texture = Level.Content.Load<Texture2D>("Tiles/Others/InvisibilityPotion");
            origin = new Vector2(texture.Width / 2.0f, texture.Height / 2.0f);
            InvisibilityPotion = Level.Content.Load<SoundEffect>("Audio/healthpotion");
        }

        public void CollectedCoins(Player collis)
        {
            InvisibilityPotion.Play();
        }
